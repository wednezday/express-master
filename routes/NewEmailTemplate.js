...
router.post('/', function (req, res) {
  ...
  connection.connect().then(function () {
      ...
      request.query(`select * from EmailTemplate WHERE [Code] = '${req.body.Code}'` , function (err, recordset) {
  ...
  connection.connect().then(function () {
    ...
    request.query('select * from HotelInformation', function (err, recordset) {
      ...
      if (err) {
        ...
        //res.render('NewEmailTemplate', {
        //  IDEmailSystem: post.IDEmailSystem,
        //  Email: post.Email,
        //  posts: posts,
        //  IDHotelInformation: HIpost.IDHotelInformation,
        //  Code: HIpost.Code,
        //  Name: HIpost.Name,
        //  Address: HIpost.Address,
        //  Logo: HIpost.Logo
...
// query to the database and get the records
//        request.query('select * from EmailSystem; select * from HotelInformation;', function (err, recordset) {
...
//                  return post.IDEmailSystem
//                })[0]

//                const HIposts = recordset.recordsets[1];
...
router.route('/save')
  ...
  .post(function (req, res) {
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td align="center" valign="top" style="border-collapse:collapse !important;border-spacing:0;margin:0;padding:0;padding-top:20px;-webkit-font-smoothing:antialiased;text-size-adjust:100%;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;line-height:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                          <a href="${req.body.LinkImg1}"> <img border="0" vspace="0" hspace="0" src="cid:img1@arnoma.com" alt="Please enable images to view this content" title="Hero Image" width="560" style="max-width:560px;color:#000000;font-size:13px;margin:0;padding:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;border:0;display:block;line-height:100%;" /> </a>                          </td>
                      </tr>
                      <tr>
    ...
    connection.connect().then(function () {
      ...
      var sql = `INSERT INTO EmailTemplate ([Code],[Name],[IDEmailSystem],[Topics],[Message1],[Message2],[Img1],[Img2],[Img3],[Img4],[Img5],[ImgFooter1],[ImgFooter2],[ImgFooter3],[ImgFooter4],[HTMLTemplate],[LinkImg1],[LinkImg2],[LinkImg3],[LinkImg4],[LinkImg5],[LinkImgFoot1],[LinkImgFoot2],[LinkImgFoot3],[LinkImgFoot4] ) VALUES 
  ('${req.body.Code}' , '${req.body.Name}' , '${req.body.IDEmailSystem}' , '${req.body.Topics}' , '${req.body.Message1}' , '${req.body.Message2}' , '${req.body.Img1}' , '${req.body.Img2}', '${req.body.Img3}' , '${req.body.Img4}', '${req.body.Img5}', '${req.body.ImgFooter1}', '${req.body.ImgFooter2}', '${req.body.ImgFooter3}', '${req.body.ImgFooter4}' , '${htmlTemplate}' ,
  '${req.body.LinkImg1}' , '${req.body.LinkImg2}' , '${req.body.LinkImg3}' , '${req.body.LinkImg4}' , '${req.body.LinkImg5}' , '${req.body.LinkImgFoot1}' , '${req.body.LinkImgFoot2}' , '${req.body.LinkImgFoot3}' , '${req.body.LinkImgFoot4}')`;
